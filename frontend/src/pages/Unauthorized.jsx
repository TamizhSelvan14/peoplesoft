    ...
    return (
        <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '100vh' }}>
            <div className="card p-4 text-center shadow" style={{ maxWidth: '500px' }}>
                <div className="mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="#dc3545" className="bi bi-shield-x" viewBox="0 0 16 16">
                ...
                <div className="alert alert-warning mb-3" style={{ fontSize: '14px' }}>
                    <strong>Your Role:</strong> {userRole?.toUpperCase() || 'Unknown'}<br />
